...
/// Render a rectangle of the Mandlebrot set into buffer of pixels.
fn render(
  pixels: &mut [u8],
  bounds: (usize, usize),
...
/// limit without being able to prove that `c` is not a member) return `None`.
...
/// Parse a string of two numeric values separated by `separator` character.
